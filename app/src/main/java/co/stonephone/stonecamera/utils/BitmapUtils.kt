...
//Copied from https://github.com/googlesamples/mlkit/blob/master/android/vision-quickstart/app/src/main/java/com/google/mlkit/vision/demo/BitmapUtils.java
...
fun getBitmap(image: ImageProxy): Bitmap? {
    val frameMetadata: FrameMetadata =
        FrameMetadata.Builder()
            ...
            .setRotation(image.imageInfo.rotationDegrees.toFloat())
            .build()
...
fun Bitmap.scaleDown(targetWidth: Float): Bitmap {
